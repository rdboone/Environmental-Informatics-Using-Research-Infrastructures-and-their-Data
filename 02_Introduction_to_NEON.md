...
### Exercise 2.3: NEON Coding Lab - Further Exploration of NEON Data
...
6.  Using the NEON Ulitites package or the API pull in those data along
    with metadata.
...
7.  Organize your data into `data.frames` and produce summaries for each
    of your data:
...
8.  Filter and format your data based on metadata and quality flags:
...
9.  Create minimum of 1 plot per data type (minimum of 3 plots total).
...
10. What is the temporal frequency of observations in the data you
