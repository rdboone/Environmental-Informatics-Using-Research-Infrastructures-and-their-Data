...
```{r calculate-structural-diversity-metrics, eval = F, fig.cap="Canopy Height Model (CHM) of HARV study area"}
...
```{r load-libraries, eval=F, warning=FALSE}
...
```{r download-chm, eval=F, message=FALSE}
...
```{r import and plot base plots, eval=F}
